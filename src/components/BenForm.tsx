...
const submitToBackend = async (e:React.SyntheticEvent) => {
   ...
   await fetch("http://localhost:8000/beneficiary", {
    ...
    return (
        <div className="text-3xl font-bold underline w-full">
          <Head>
          ...
          <main>
            ...
            <form onSubmit={submitToBackend}>
              ...
              <input className="text-justify" type={"text"} id={"beneficiary"} ref={nameInputRef} />
              <button className='bg-red-900' type="submit">Submit to backend</button>
            </form>
            <h4>{response}</h4>
          </main>
        </div>
